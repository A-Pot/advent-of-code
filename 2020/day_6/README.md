<h1 align="center">Advent of Code: <a href="https://adventofcode.com/2020/day/6" target="_blank">Day 6</a></h1>
...
<p>Your puzzle answer was <code>6542</code>.</p><article class="day-desc"><h2 id="part2">--- Part Two ---</h2><p>As you finish the last group's customs declaration, you notice that <span title="Don't worry, nobody ever misreads just one word in real life.">you misread one word</span> in the instructions:</p>
...
<p>Your puzzle answer was <code>3299</code>.</p><p class="day-success">Both parts of this puzzle are complete! They provide two gold stars: **</p>