<h1 align="center">Advent of Code: <a href="https://adventofcode.com/2020/day/4" target="_blank">Day 4</a></h1>
...
<p>Your puzzle answer was <code>245</code>.</p><article class="day-desc"><h2 id="part2">--- Part Two ---</h2><p>The line is moving more quickly now, but you overhear airport security talking about how passports with invalid data are getting through. Better add some data validation, quick!</p>
...
<p>Your puzzle answer was <code>133</code>.</p><p class="day-success">Both parts of this puzzle are complete! They provide two gold stars: **</p>