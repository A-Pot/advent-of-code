<h1 align="center">Advent of Code: <a href="https://adventofcode.com/2020/day/2" target="_blank">Day 2</a></h1>
...
<p>Your puzzle answer was <code>396</code>.</p><article class="day-desc"><h2 id="part2">--- Part Two ---</h2><p>While it appears you validated the passwords correctly, they don't seem to be what the Official Toboggan Corporate Authentication System is expecting.</p>
...
<p>Your puzzle answer was <code>428</code>.</p><p class="day-success">Both parts of this puzzle are complete! They provide two gold stars: **</p>