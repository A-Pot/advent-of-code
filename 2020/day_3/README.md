<h1 align="center">Advent of Code: <a href="https://adventofcode.com/2020/day/3" target="_blank">Day 3</a></h1>
...
<p>Your puzzle answer was <code>164</code>.</p><article class="day-desc"><h2 id="part2">--- Part Two ---</h2><p>Time to check the rest of the slopes - you need to minimize the probability of a sudden arboreal stop, after all.</p>
...
<p>Your puzzle answer was <code>5007658656</code>.</p><p class="day-success">Both parts of this puzzle are complete! They provide two gold stars: **</p>